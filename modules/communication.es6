class Communication {
    ...
    constructor() {
        // Communication.Colors = Object.freeze({
        //     RED:   Symbol("red"),
        //     BLUE:  Symbol("blue"),
        //     GREEN: Symbol("green")
        // });
    ...
    sendToBackground(_code,_data, callback) {
        ...
        chrome.runtime.sendMessage({todo:_code, data:_data}, function(response) {
